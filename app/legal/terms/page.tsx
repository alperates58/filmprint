...
export const metadata = {
  title: "Kullanım Koşulları — Filmprint",
  description: "Filmprint platformu kullanım koşulları, kullanıcı hakları ve hizmet şartları.",
};
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-12 space-y-8 w-full">
        ...
        <div className="p-8 rounded-3xl bg-surface border border-border/80 space-y-6 text-xs md:text-sm text-text-secondary leading-relaxed shadow-cinematic">
          <section className="space-y-2">
            ...
            <p>
              Filmprint platformuna erişerek veya platformu kullanarak, işbu Kullanım Koşulları'nı okuduğunuzu, anladığınızı ve kabul ettiğinizi beyan etmiş olursunuz. Koşulları kabul etmiyorsanız lütfen platformu kullanmayınız.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Filmprint; kullanıcıların film etkileşimlerini (izlendi, izlenmedi, beğeni vb.) analiz ederek kişiselleştirilmiş "Film DNA" profili oluşturan ve matematiksel algoritmalar vasıtasıyla film önerileri sunan bir kalibrasyon platformudur.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Filmprint, sunulan hizmetleri önceden haber vermeksizin değiştirme veya durdurma hakkını saklı tutar. Platform üzerinden sunulan öneriler kişiselleştirilmiş istatistiki tahminler olup %100 memnuniyet garantisi taahhüt etmez.
            </p>
          </section>
