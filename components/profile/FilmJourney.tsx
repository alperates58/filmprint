    ...
    <div className="p-6 md:p-8 rounded-3xl bg-surface-1 border border-border/80 shadow-md space-y-6">
      ...
      <div className="space-y-3 font-sans">
        <div className="flex justify-between items-center text-xs">
          ...
          {!isMaxRank && nextRank && (
            <span className="text-text-primary font-medium">
              Sıradaki: <span className="text-accent font-semibold">{nextRank.label}</span> ({remaining} film kaldı)
            </span>
          )}
        </div>
        ...
        <p className="text-xs text-text-muted font-sans italic">
          Film DNA&apos;nız daha fazla film değerlendirdikçe derinleşmeye ve keskinleşmeye devam eder.
        </p>
      </div>
