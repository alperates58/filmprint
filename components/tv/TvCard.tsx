              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5">
                  <button
                    ...
                    className="min-h-[48px] px-2.5 sm:px-3 py-3 rounded-2xl bg-accent text-white font-sans font-semibold text-xs sm:text-sm hover:bg-accent-hover active:scale-95 transition-all shadow-sm flex items-center justify-center gap-1.5 whitespace-nowrap"
                  >
                    <span>👁️</span>
                    <span>İzledim</span>
                  ...
                  <button
                    ...
                    className="min-h-[48px] px-2.5 sm:px-3 py-3 rounded-2xl bg-surface-2 border border-border hover:border-accent text-text-primary font-sans font-medium text-xs sm:text-sm hover:bg-surface-3 active:scale-95 transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
                  >
                    <span>⏳</span>
                    <span>Kısmen</span>
                  ...
                  <button
                    ...
                    className="min-h-[48px] px-2.5 sm:px-3 py-3 rounded-2xl bg-surface-2 border border-border hover:border-border-strong text-text-secondary font-sans font-medium text-xs sm:text-sm hover:bg-surface-3 active:scale-95 transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
                  >
                    <span>✕</span>
                    <span>İzlemedim</span>
                    <span className="hidden md:inline-block ml-1 px-1.5 py-0.5 rounded bg-surface-1 text-text-muted text-[10px] font-mono">
